                        ...
                        <form onSubmit={props.handleSubmit}>
                            ...
                            <div className="row mb-4">
                                ...
                                <input 
                                    name="location"
                                    type="text" 
                                    value={props.applicant.location}
                                    onChange={props.handleChange}
                                    className="form-control"
                                    id="inputLocation"
                                    onKeyDown={preventEnterSubmit}
                            ...
                            <div className="row mb-4">
                                ...
                                <input 
                                    name="noticePeriod"
                                    type="text" 
                                    value={props.applicant.noticePeriod}
                                    onChange={props.handleChange}
                                    className="form-control"
                            ...
                            <div className="input-group mb-4">
                                ...
                                <textarea 
                                    name="description"
                                    value={props.applicant.description} 
                                    onChange={props.handleChange}
                                    className="form-control" 
                                ...
                                <div className="col-lg-10">
                                    <div className="form-check">
                                        <input 
                                            name="knowsReact"
                                            type="checkbox" 
                                            checked={props.applicant.knowsReact}
                                            onChange={props.handleChange}
                                    ...
                                    <div className="form-check">
                                        <input 
                                            name="knowsAngular"
                                            type="checkbox" 
                                            checked={props.applicant.knowsAngular}
                                            onChange={props.handleChange}
                                            className="form-check-input" 
                                            id="angularCheck" 
                                    onKeyDown={preventEnterSubmit}
                                    ...
                                    <div className="form-check">
                                        <input 
                                            name="knowsMongo"
                                            type="checkbox" 
                                            checked={props.applicant.knowsMongo}
                                            onChange={props.handleChange}
                                            className="form-check-input" 
                                            id="mongoCheck" 
                                    onKeyDown={preventEnterSubmit}
                                    ...
                                    <div className="form-check">
                                        <input 
                                            name="knowsExpress"
                                            type="checkbox" 
                                            checked={props.applicant.knowsExpress}
                                            onChange={props.handleChange}
                                            className="form-check-input"
                                            id="expressCheck" 
                                    onKeyDown={preventEnterSubmit}
